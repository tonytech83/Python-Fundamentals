...
# check if one of the lines contains only 1
if row_1.count(1) == 3 or row_2.count(1) == 3 or row_3.count(1) == 3:
    player_one_win = True

# check if one of the lines contains only 2
...
# if element in middle of line 2 is 1 than check left and right diagonals for 1
elif row_2[1] == 1:
    if row_1[0] == 1 and row_3[2] == 1 or row_1[2] == 1 and row_3[0] == 1:
        player_one_win = True

# if element in middle of line 2 is 2 than check left and right diagonals for 2
elif row_2[1] == 2:
